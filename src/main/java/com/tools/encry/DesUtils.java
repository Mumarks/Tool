...
public class DesUtils {
	...
	/** 签证加密密钥 */
	public final static String Key = "0ed74703d3ba0c2b6aa5ffb636374e2a";
	
	/** 字符串默认键值 */
	private static String strDefaultKey = "ac150c809470478ea4b2ea1d85dac1b5";
	...
	public static String enString(String value){
		...
		try {
			...
			enStr = des.encrypt(value);
		} catch (Exception e) {
			log.error("对称加密DES->默认密钥加密失败", e);
		}
		return enStr;
	}
	 ...
	 * @return null 失败
	 */
	public static String enString(String value, String key){
		String enStr = null;
		try {
			DesUtils des = new DesUtils(key);
			enStr = des.encrypt(value);
		} catch (Exception e) {
			log.error("对称加密DES->自定义密钥加密失败", e);
		}
		return enStr;
	}
	...
	public static String deString(String value){
		...
		try {
			DesUtils des = new DesUtils();
			deStr = des.decrypt(value);
		} catch (Exception e) {
			log.error("对称加密DES->默认密钥解密失败", e);
		}
		return deStr;
	}
	 ...
	 * @return  null 失败
	 */
	public static String deString(String value, String key){
		String deStr = null;
		try {
			DesUtils des = new DesUtils(key);
			deStr = des.decrypt(value);
		} catch (Exception e) {
			log.error("对称加密DES->自定义密钥解密失败", e);
		}
		return deStr;
	}
